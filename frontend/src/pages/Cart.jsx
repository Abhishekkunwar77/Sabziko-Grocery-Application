    ...
    <div className="flex flex-col md:flex-row mt-16">
                ...
                <div className="font-normal text-gray-500/70">
                  ...
                  <div className="flex items-center">
                    ...
                    <select
                      ...
                      className=" outline-none text-primary-dull border border-gray-300 rounded  py-1 ml-2"
                    >
                      {Array(
      ...
      <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
            ...
            {showAddress && (
              <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                ...
                <p
                  ...
                  className="text-primary text-center cursor-pointer p-2 hover:bg-primary-dull/35 "
                >
                  Add address
                </p>
              </div>
        ...
        <button
          ...
          className={`w-full py-3 mt-6 font-medium transition cursor-pointer bg-primary text-white hover:bg-primary-dull`}
        >
